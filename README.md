...
**_This is a work in progress, so you can only back up your songs (for now)._**
...
- Backing up:
  ...
  This will create a `osu_backup.json` file containing all the song titles and their respective links.
